...
function main() {
  console.log(chalk.blue('Setting up MCP Product Documentation Server...'));
  ...
  if (success) {
    console.log(chalk.green('✓ MCP Product Documentation Server setup complete!'));
    console.log(chalk.blue('You can now run: npm start'));
    console.log(chalk.blue('Or get configuration: npm run config'));
  } else {
